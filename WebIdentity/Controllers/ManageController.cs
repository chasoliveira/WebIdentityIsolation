...
using WebIdentity.Domain.Repositories;
using WebIdentity.Domain.ViewModels;
...
#region Helpers
        ...
        {
            return UserManager.HasPassword(User.Identity.GetUserId<int>());
        }

        private bool HasPhoneNumber()
        {
            return UserManager.HasPhoneNumber(User.Identity.GetUserId<int>()).Result;
        }
